const initMessages = {
    ...
    sandboxRunning:(PORT: string | number) => { return `graphQlApi ---- \x1b[35m[${new Date().toISOString().slice(0, 19)}]\x1b[0m GraphQL Sandbox is running on URL: \x1b[36mhttp://localhost:${PORT}/graphql\x1b[0m \x1b[32mREADY\x1b[0m`},
